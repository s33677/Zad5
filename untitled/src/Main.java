// Przykład interakcji między obiektami i kopiowania przezreferencję
...
// Dokonaj rezerwacji - przekazanie obiektu Klient i
Wydarzenie
...
Wydarzenie koncertRef = system.znajdźWydarzenie("Koncert
        Symphony");
// Modyfikacja wydarzenia przez referencję - wpłynie nawszystkich klientów, którzy mają to wydarzenie
...
System.out.println("\nRezerwacje klienta " +
                   klient1.getImię() + " " + klient1.getNazwisko() + " po
zmianie ceny:");
        klient1.wyświetlRezerwacje();
System.out.println("\nRezerwacje klienta " +
                   klient2.getImię() + " " + klient2.getNazwisko() + " po
zmianie ceny:");
        klient2.wyświetlRezerwacje();
// Klient anuluje rezerwację - operacja na referencjach
System.out.println("\nKlient " + klient1.getImię() + "
anuluje rezerwację na teatr:");
